<div class="module-content module-surface body-title disabled" data-module="moduleSurface">
    ...
    <div class="menu-content overflow-y disabled" data-surface-type="settings">
        <div class="menu-list">
            ...
            <div class="menu-link active" data-action="toggleSectionProfile">
                <div class="menu-link-icon">
            ...
            <div class="menu-link" data-action="toggleSectionLogin">
                <div class="menu-link-icon">
            ...
            <div class="menu-link" data-action="toggleSectionAccessibility">
                <div class="menu-link-icon">
            ...
            <div class="menu-link" data-action="toggleSectionPurchaseHistoryFromSettings">
                <div class="menu-link-icon">
